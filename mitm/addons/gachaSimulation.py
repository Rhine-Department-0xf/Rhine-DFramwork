...
class gachaSimulation(ArkInterceptor):
    ...
    def __init__(self, dp=dataPath,baodi = True):
        self.poolData = {
            "poolInfo": [
                {"rarityRank": 5,"charIdList": ["char_350_surtr"],"totalPercent": 0.02,"upPercent":0.5},
                {"rarityRank": 4,"charIdList": ["char_350_surtr"],"totalPercent": 0.08,"upPercent":0.5},
                {"rarityRank": 3,"charIdList": ["char_350_surtr"],"totalPercent": 0.5,"upPercent":0.2},
                {"rarityRank": 2, "charIdList": ["char_350_surtr"], "totalPercent": 0.4,"upPercent":0}
            ]}
        try:
