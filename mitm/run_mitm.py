...
from addons.TestFor import TestFor
...
from mitm.addons.changeSeed import changeSeed
from mitm.addons.decryptBattleData import decryptBattleData
...
if __name__ == "__main__":
    ...
    master.addons.add(decryptBattleData())
    ...
    # master.addons.add(changeSeed(85208900))
    # master.addons.add(unlockSkins())
    # mc = moreChars()
    # mc.addChars(["trap_035_emperor"])
    # master.addons.add(mc)
    # master.addons.add(TestFor())
    # master.addons.add(fakeGacha())
    master.addons.add(userInfo.init("rua牛海猫贴贴喵喵","0000",120,0))
    master.addons.add(userData.init(999,999,666,234444,101))
    #
    # gs = gachaSimulation()
    # gs.setUp("char_350_surtr")
